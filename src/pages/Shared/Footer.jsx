    ...
    return (
        <>
            <footer className="footer p-10 bg-base-200 text-base-content mt-10">
                <aside>
                    <GrTechnology className="ml-2 text-3xl"/>
                    <p>TechHub<br />Gratifying innovation need since 2012</p>
                </aside>
                <nav>
                    ...
                    <a className="link link-hover">TechHub@example.com</a>
                </nav>
                <nav>
            ...
            <footer className="footer py-4 border-t bg-base-200 text-base-content border-base-300">
                    <p className="mx-auto">Copyright © 2024 - All right reserved</p>
            </footer>
        </>
    );
};
